...
{
PreparedStatement ps=con.prepareStatement("select * from buyla where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyla set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formla.jsp" method="post" name="f1"><center>
