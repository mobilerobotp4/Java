<html><head><title>Add To Cart</title>
<style type="text/css">
...
{
PreparedStatement ps=con.prepareStatement("select * from buyg where ProductNo=?");%>
<font color="#333399" size="+2"><div align="left"><table border="5" bgcolor="#6699CC"><tr><th>Product No <th>description <th>Price <th>Available Item</tr>
...
PreparedStatement ps1=con1.prepareStatement("update buyg set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table><div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formg.jsp" method="post" name="f1"><center>
 ...
 Amount :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="amt"><br><br><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<input type="submit" value="SUBMIT" onClick="return validate(this.form)">&nbsp;&nbsp;<input type="reset" value="RESET"></center>
 </form><center><% }
 else
 {
