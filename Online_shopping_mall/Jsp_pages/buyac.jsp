<html><title>Add To Cart</title><head>
<style type="text/css">
...
{
PreparedStatement ps=con.prepareStatement("select * from buyac where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyac set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formac.jsp" method="post" name="f1"><center>
