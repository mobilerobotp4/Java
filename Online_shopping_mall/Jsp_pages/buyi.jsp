...
{
PreparedStatement ps=con.prepareStatement("select * from buyi where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyi set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formi.jsp" method="post" name="f1"><center>
 ...
 Amount :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<input type="text" name="amt"><br><br><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<input type="submit" value="Submit" onClick="return validate(this.form)"></center></font>
 </form><% }
 else
 {
