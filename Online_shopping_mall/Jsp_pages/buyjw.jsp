...
{
PreparedStatement ps=con.prepareStatement("select * from buyjw where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyjw set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formjw.jsp" method="post" name="f1"><center>
