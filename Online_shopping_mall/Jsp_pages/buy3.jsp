...
{
PreparedStatement ps=con.prepareStatement("select * from buy3 where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buy3 set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/form2.jsp" method="post" name="f1"><center>
