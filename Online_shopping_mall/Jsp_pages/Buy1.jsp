<html><head><title>Suprize Your Child With New Gifts!!!!!</title>
<style type="text/css">
...
{
PreparedStatement ps=con.prepareStatement("select * from buy1 where ProductNo=?");%>
<div align="left"><table border="5" bgcolor="#6699CC"><tr><th>Product No <th>description <th>Price <th>Available Item</tr>
...
%>
<tr align="center" style="Edwardian Script ITC"><td><%=nop %><td><%=des %><td><%=total %>/-<td><%= in %></td></tr><%
sum+=Integer.parseInt(total);
ai=Integer.parseInt(in);
ai=ai-1;
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
Connection con1=DriverManager.getConnection("jdbc:odbc:db");
PreparedStatement ps1=con1.prepareStatement("update buy1 set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
out.println("<br><div align=left> TOTAL  PRICES......: "+sum+"/-</div><br><br>");
//session.setMaxInactiveInterval(15);
session.setAttribute("amount2",new Integer(sum)); 
sum=0;
 %>
 
 </font><form action="http://localhost:8090/shopping/form.jsp" method="post" name="f1"><center>
               <p><font color="#003366" size="5">-:FILL UP YOUR FORM:-<br>
                 <br>
                 Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <br>
               <font color="#003366"  size="5">C.card No:&nbsp;&nbsp;&nbsp;&nbsp;
