...
{
PreparedStatement ps=con.prepareStatement("select * from buych where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buych set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formch.jsp" method="post" name="f1"><center>
