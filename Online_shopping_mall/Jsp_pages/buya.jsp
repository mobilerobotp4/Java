<html><head><title>Buy Best Movies</title>
<style type="text/css">
...
{
PreparedStatement ps=con.prepareStatement("select * from buya where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buya set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0; 
 ...
 <form action="http://localhost:8090/shopping/forma.jsp" method="post" name="f1"><center>
 ...
 Credit No :&nbsp;&nbsp;<input type="password" name="accno"><br><br>
