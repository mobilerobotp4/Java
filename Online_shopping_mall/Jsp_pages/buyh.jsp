...
{
PreparedStatement ps=con.prepareStatement("select * from buyh where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyh set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formh.jsp" method="post" name="f1"><center>
