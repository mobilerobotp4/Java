...
<% 
 String[] np;
np=request.getParameterValues("Computer");
...
{
PreparedStatement ps=con.prepareStatement("select * from buyl where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyl set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/forml.jsp" method="post" name="f1"><center>
               -:FILL UP YOUR FORM:-<br><br>
<img src="index/shop copy.gif" width="186" align="left">
