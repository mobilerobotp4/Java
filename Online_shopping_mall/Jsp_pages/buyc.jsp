...
{
PreparedStatement ps=con.prepareStatement("select * from buyc where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyc set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formc.jsp" method="post" name="f1"><center>
