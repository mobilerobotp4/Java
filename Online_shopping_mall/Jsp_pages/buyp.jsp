...
{
PreparedStatement ps=con.prepareStatement("select * from buyp where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buyp set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
