...
{
PreparedStatement ps=con.prepareStatement("select * from buytr where ProductNo=?");%>
...
PreparedStatement ps1=con1.prepareStatement("update buytr set AvailableItem='"+ai+"' where ProductNo='"+nop+"'");
ps1.executeUpdate();
}
}}%></table></div><%
...
sum=0;
 ...
 <form action="http://localhost:8090/shopping/formtr.jsp" method="post" name="f1"><center>
